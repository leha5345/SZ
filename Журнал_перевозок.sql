...
select 
	...
	,COUNT(L.STOREDINVOICEEXTERNALID) OVER (PARTITION BY L.DATAAREAID,L.JOURNALID ORDER BY L.JOURNALID) as R -- Рассчитанное количество накладных в журнале
	,SUM(CASE WHEN L.SZ_INVOICEIDISSUERECEIVER <> '' THEN 1 ELSE 0 END) OVER (PARTITION BY L.DATAAREAID,L.JOURNALID ORDER BY L.JOURNALID) as R_SUM -- Рассчитанное количество МП накладных в журнале
